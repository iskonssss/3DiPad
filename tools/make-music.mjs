...
const TUNES = {
  'CRAZY-FROG': {
    title: 'Crazy Frog — Axel F (hook)',
    // The Axel F riff, one octave down so it sits in the register the motors
    // play cleanly. F Ab F F Bb F Eb  /  F C F F Db C Ab F C F.
    notes: [
      [53,46],[0,8],[56,24],[53,24],[0,8],[53,24],[58,24],[53,44],[51,50],[0,16],
      [53,46],[60,24],[53,24],[0,8],[53,24],[61,24],[60,44],[56,24],[53,24],[60,24],[53,58],
    ],
  },
};
